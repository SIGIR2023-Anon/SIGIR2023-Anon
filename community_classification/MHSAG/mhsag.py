...
def trainer(dataset):
    model = mhsag(num_features=args.input_dim, hidden_size=args.hidden_size,
...
if __name__ == "__main__":
    ...
    args.pretrain_path = f'./pretrain/premhsag_{args.name}_{args.epoch}.pkl'
